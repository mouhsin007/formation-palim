 ...
 */
@Entity
public class IsFacture implements Serializable {
    ...
    public ImpotSociete getImpotSociete() {
        return impotSociete;
    }

    public void setImpotSociete(ImpotSociete impotSociete) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof IsFacture)) {
            return false;
        }
        IsFacture other = (IsFacture) object;
